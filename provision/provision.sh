...
ln -sf /vagrant/config/apt-source-append.list /etc/apt/sources.list.d/vvv-sources.list | echo "Linked custom apt sources"
...
DOMAINS='wp.wsu.edu content.wp.wsu.edu network1.wp.wsu.edu network2.wp.wsu.edu site1.network1.wp.wsu.edu site2.network1.wp.wsu.edu school1.wsu.edu school2.wsu.edu site1.school1.wsu.edu site2.school1.wsu.edu'
